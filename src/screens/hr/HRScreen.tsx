...
import { faMoneyCheckDollar } from '../../theme/icons';
    ...
    <FlatList
      ...
      ListHeaderComponent={
        <View style={styles.header}>
          <FontAwesomeIcon icon={faMoneyCheckDollar} size={48} color={colors.primary} style={styles.icon} />
          <Text style={styles.title}>HR Management</Text>
          <Text style={styles.subtitle}>Payroll, contracts, time tracking, and staff management</Text>
        </View>
      }
      ListEmptyComponent={
